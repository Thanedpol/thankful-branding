...
export const demoPortfolio: Portfolio[] = [
  ...
  { id: "vw3", title: "Snobby Story", description: "นิทานสอนใจ ดีๆ ที่จะช่วยให้เด็กเติบโตไปอย่างมั่นคง — ใช้ AI สร้างการ์ตูนนิทานสอนใจสำหรับเด็ก", tech_tags: ["AI Cartoon", "Storytelling", "Kids"], category: "Video", featured: true, display_order: 3, thumbnail_url: "/portfolio/snobby-story.svg", project_url: "/portfolio/snobby-story", created_at: "" },
];
