...
export const demoPortfolio: Portfolio[] = [
  ...
  { id: "vw4", title: "Insightist", description: "Content Creator ทีมข่าวเทคโนโลยีและ AI ของ Insightist AI Transformation Thailand — ลงพื้นที่ทำข่าวงานสัมมนา/นิทรรศการกว่า 23 งาน", tech_tags: ["AI News", "Journalism", "On-site Reporting"], category: "Other", featured: true, display_order: 4, thumbnail_url: "/portfolio/insightist.svg", project_url: "/portfolio/insightist", created_at: "" },
];
