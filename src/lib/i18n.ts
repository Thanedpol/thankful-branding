...
export const dict: Record<Locale, Dict> = {
  th: {
    ...
    "footer.blurb": "Content Creator เล่าข่าว AI ธุรกิจ วิทยาศาสตร์และเทคโนโลยี ทั้งในไทยและต่างประเทศ ให้เข้าใจง่ายและนำไปใช้ได้จริง",
    "footer.explore": "เมนู",
    "footer.follow": "ติดตาม",
    "footer.rights": "สงวนลิขสิทธิ์",
    "footer.top": "ขึ้นบนสุด ↑",
  ...
  en: {
    ...
    "footer.blurb": "Content creator covering AI, business, science and technology — in Thailand and beyond, made simple and useful.",
  ...
  zh: {
    ...
    "footer.blurb": "内容创作者 — 报道 AI、商业、科学与科技，覆盖泰国及海外，通俗易懂、实用落地。",
    "footer.explore": "导航",
    "footer.follow": "关注",
    "footer.rights": "版权所有。",
    "footer.top": "回到顶部 ↑",
